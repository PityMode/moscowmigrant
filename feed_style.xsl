  ...
  <xsl:template match="/">
    <html xmlns="http://www.w3.org/1999/xhtml">
      <head>
        ...
        <link type="text/css" rel="stylesheet" href="https://moscowmigrant.com/css/styles.abbd6311bb4b6ca58f8e7398140529245ae0f6428b759fcd830742eee2619eabb900ba9914a9affb82aa9a16a9b9ea727bb315315a976a0db0e7513a5f12c504.css" integrity="sha512-q71jEbtLbKWPjnOYFAUpJFrg9kKLdZ/NgwdC7uJhnqu5ALqZFKmv+4Kqmhapuepye7MVMVqXag2w51E6XxLFBA==" />
        <style>
          .aboutfeeds {
      ...
      <body>
        <header>
          ...
          <div class="head">
            <div class="avatar">
              <img class="logo" src="/moscowmigrant256.png" alt="Site Logo"/>
            </div>
